 ...
 * @author Joris
 */
public class SimpleHit extends Scenario
{
        @Override
        ...
        protected void setup()
        {
                ...
                actorWarp(0, 0, ACTOR_2, false, 517 * PhysicsMap.TILE_PIXELS, 512 * PhysicsMap.TILE_PIXELS, -1024, 0, PhysicsEnvironment.ROTATION_1_2TH);
