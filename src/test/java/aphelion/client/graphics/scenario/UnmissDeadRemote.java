 ...
 * @author Joris
 */
public class UnmissDeadRemote extends Scenario
{
        @Override
        ...
        protected void setup()
        {
                ...
                actorWarp(0, 0, ACTOR_LOCAL, false, 508 * PhysicsMap.TILE_PIXELS, 513 * PhysicsMap.TILE_PIXELS + 8000, -1024, 0, PhysicsEnvironment.ROTATION_1_4TH);
