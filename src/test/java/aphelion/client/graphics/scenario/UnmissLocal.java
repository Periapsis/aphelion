 ...
 * @author Joris
 */
public class UnmissLocal extends Scenario
{
        @Override
        ...
        protected void setup()
        {
                ...
                actorWeapon(0, 100, ACTOR_2, WEAPON_SLOT.GUN_MULTI);
                
                for (long t = 90; t < 95; ++t)
                {
                        actorMove(150, t, ACTOR_2, PhysicsMovement.get(false, false, true, false, false));
                }
        }
