...
public class DeadLocalHitWall extends Scenario
{
        ...
        protected void setup()
        {
                ...
                actorWarp(0, 0, ACTOR_2, false, 508 * PhysicsMap.TILE_PIXELS, 500 * PhysicsMap.TILE_PIXELS, -3000, 0, PhysicsEnvironment.ROTATION_1_4TH);
                
                actorNew(0, ACTOR_LOCAL, 5678, "warbird");
                actorWarp(0, 0, ACTOR_LOCAL, false, 517 * PhysicsMap.TILE_PIXELS, 500 * PhysicsMap.TILE_PIXELS, -3000, 0, PhysicsEnvironment.ROTATION_1_2TH);
