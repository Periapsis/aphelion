...
public class GCEnum<T> extends SimpleAbstract<T>
{
        public static class Factory implements WrappedValueAbstract.Factory {
                ...
                {
                        return new GCEnum(resolver, selection, key);
                }
        };

        private final EnumResolver<T> resolver;

        public GCEnum(@Nonnull EnumResolver<T> resolver, @Nonnull ConfigSelection selection, @Nonnull String key)
        {
                super(selection, key);
                this.resolver = resolver;
        }
        ...
        {
                return this.getBoxed();
        }

        @Override
        protected @Nullable T castValue(Object value)
        {
        ...
        @Override
        protected @Nullable T unsetValue()
        {
                return resolver.getUnsetValue();
        }
}
