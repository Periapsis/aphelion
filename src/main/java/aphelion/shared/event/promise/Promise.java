...
{
        private AbstractPromise parent;

        public Promise(Workable workable)
        {
                super(workable);
        }

        void setParent(AbstractPromise parent)
        {
                this.parent = parent;
        ...
        @Override
        public void then(All list, int myIndex)
        {
                if (parent != null)
                {
                        parent.then(list, myIndex);
                }

                super.then(list, myIndex);
        }
}
