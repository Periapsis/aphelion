 ...
 * @author kevin
 */
public class SWASlickImageBuffer implements ImageData {
	 ...
	 * @param height
	 */
	public SWASlickImageBuffer(int width, int height) {
		this.width = width;
		this.height = height;
