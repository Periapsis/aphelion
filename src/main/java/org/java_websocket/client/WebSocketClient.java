...
public abstract class WebSocketClient extends WebSocketAdapter implements Runnable, WebSocket {
	...
	public WebSocketClient(WebSocketClientFactory factory, URI serverURI ) {
		this(factory, serverURI, new Draft_10() );
	}
	 ...
	 */
	public WebSocketClient(WebSocketClientFactory factory, URI serverUri , Draft draft ) {
		this(factory, serverUri, draft, null, 0 );
	}

	public WebSocketClient(WebSocketClientFactory factory, URI serverUri , Draft draft , Map<String,String> headers , int connecttimeout ) {
                wsfactory = factory;
		if( serverUri == null ) {
